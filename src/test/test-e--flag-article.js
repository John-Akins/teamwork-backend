        ...
        describe('flag article', () => {
            describe('user is authorized', () => {
                ...
                before((done) => {
                        ...
                        .end((error, response) => {
                            authorizedUserSecrets.data = response.body.data
                            done()
                        })
                    })
                before((done) => {
                        ...
                        .set({
                            ...
                            "Authorization": `token: ${authorizedUserSecrets.data.token}`
                        })
                        .send({
                            userId: authorizedUserSecrets.data.userId,
                            isAdmin: authorizedUserSecrets.data.isAdmin,
                        })
                        .end((error, response) => {
